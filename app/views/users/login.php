          ...
          <?php flash('register_success'); ?>
            ...
            <nav>
                <ul class="navbar register__form__ul align-items-center justify-content-around">
                    <li class="nav-item">
                        <a class="register__form__links register__form__links--active" href="<?php echo URLROOT; ?>/users/login">Login </a>
                    </li>
                    <li class="nav-item">
                        <a class="register__form__links" href="<?php echo URLROOT; ?>/users/register">Register</a>
                    </li>
                </ul>
            </nav>
            <form class="mt-5" action="<?php echo URLROOT; ?>/users/login" method="post">
                ...
                <div class="text-center mt-5">
                    <button type="submit" class="btn btn-lg btn--blue btn--round btn--wide">Submit</button>
                </div>
            </form>
        </div>
